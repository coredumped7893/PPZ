...
class phpbb_cache_container extends \Symfony\Component\DependencyInjection\Container
{
    ...
    {
        return $this->services['config'] = new \phpbb\config\db(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['cache.driver']) ? $this->services['cache.driver'] : ($this->services['cache.driver'] = new \phpbb\cache\driver\file())) && false ?: '_'}, 'phpbbconfig');
    }
    ...
    {
        return $this->services['config_text'] = new \phpbb\config\db_text(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbbconfig_text');
    }
    ...
    {
        return $this->services['content.visibility'] = new \phpbb\content_visibility(${($_ = isset($this->services['auth']) ? $this->services['auth'] : ($this->services['auth'] = new \phpbb\auth\auth())) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['dispatcher']) ? $this->services['dispatcher'] : $this->getDispatcherService()) && false ?: '_'}, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, './../', 'php', 'phpbbforums', 'phpbbposts', 'phpbbtopics', 'phpbbusers');
    }
    ...
    {
        $instance = new \phpbb\captcha\plugins\qa('phpbbcaptcha_questions', 'phpbbcaptcha_answers', 'phpbbqa_confirm');
    ...
    {
        return $this->services['ext.manager'] = new \phpbb\extension\manager($this, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['filesystem']) ? $this->services['filesystem'] : ($this->services['filesystem'] = new \phpbb\filesystem\filesystem())) && false ?: '_'}, 'phpbbext', './../', 'php', ${($_ = isset($this->services['cache']) ? $this->services['cache'] : $this->getCacheService()) && false ?: '_'});
    }
    ...
    {
        $instance = new \phpbb\notification\type\admin_activate_user(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['language']) ? $this->services['language'] : $this->getLanguageService()) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['auth']) ? $this->services['auth'] : ($this->services['auth'] = new \phpbb\auth\auth())) && false ?: '_'}, './../', 'php', 'phpbbuser_notifications');
    ...
    {
        return $this->services['profilefields.lang_helper'] = new \phpbb\profilefields\lang_helper(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbbprofile_fields_lang');
    }
    ...
    {
        return $this->services['text_formatter.data_access'] = new \phpbb\textformatter\data_access(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbbbbcodes', 'phpbbsmilies', 'phpbbstyles', 'phpbbwords', './../styles/');
    }
    ...
    {
        $this->services['text_reparser.forum_description'] = $instance = new \phpbb\textreparser\plugins\forum_description(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbbforums');
    ...
    {
        $this->services['text_reparser.forum_rules'] = $instance = new \phpbb\textreparser\plugins\forum_rules(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbbforums');
    ...
    {
        $this->services['text_reparser.group_description'] = $instance = new \phpbb\textreparser\plugins\group_description(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbbgroups');
    ...
    {
        $this->services['text_reparser.pm_text'] = $instance = new \phpbb\textreparser\plugins\pm_text(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbbprivmsgs');
    ...
    {
        $this->services['text_reparser.poll_title'] = $instance = new \phpbb\textreparser\plugins\poll_title(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbbtopics');
    ...
    {
        $this->services['text_reparser.post_text'] = $instance = new \phpbb\textreparser\plugins\post_text(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbbposts');
    ...
    {
        $this->services['text_reparser.user_signature'] = $instance = new \phpbb\textreparser\plugins\user_signature(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbbusers');
    ...
    {
        return $this->services['user_loader'] = new \phpbb\user_loader(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, './../', 'php', 'phpbbusers');
    }
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'tables.acl_groups' => 'phpbbacl_groups',
            'tables.acl_options' => 'phpbbacl_options',
            'tables.acl_roles' => 'phpbbacl_roles',
            'tables.acl_roles_data' => 'phpbbacl_roles_data',
            'tables.acl_users' => 'phpbbacl_users',
            'tables.attachments' => 'phpbbattachments',
            'tables.auth_provider_oauth_token_storage' => 'phpbboauth_tokens',
            'tables.auth_provider_oauth_states' => 'phpbboauth_states',
            'tables.auth_provider_oauth_account_assoc' => 'phpbboauth_accounts',
            'tables.banlist' => 'phpbbbanlist',
            'tables.bbcodes' => 'phpbbbbcodes',
            'tables.bookmarks' => 'phpbbbookmarks',
            'tables.bots' => 'phpbbbots',
            'tables.captcha_qa_questions' => 'phpbbcaptcha_questions',
            'tables.captcha_qa_answers' => 'phpbbcaptcha_answers',
            'tables.captcha_qa_confirm' => 'phpbbqa_confirm',
            'tables.config' => 'phpbbconfig',
            'tables.config_text' => 'phpbbconfig_text',
            'tables.confirm' => 'phpbbconfirm',
            'tables.disallow' => 'phpbbdisallow',
            'tables.drafts' => 'phpbbdrafts',
            'tables.ext' => 'phpbbext',
            'tables.extensions' => 'phpbbextensions',
            'tables.extension_groups' => 'phpbbextension_groups',
            'tables.forums' => 'phpbbforums',
            'tables.forums_access' => 'phpbbforums_access',
            'tables.forums_track' => 'phpbbforums_track',
            'tables.forums_watch' => 'phpbbforums_watch',
            'tables.groups' => 'phpbbgroups',
            'tables.icons' => 'phpbbicons',
            'tables.lang' => 'phpbblang',
            'tables.log' => 'phpbblog',
            'tables.login_attempts' => 'phpbblogin_attempts',
            'tables.migrations' => 'phpbbmigrations',
            'tables.moderator_cache' => 'phpbbmoderator_cache',
            'tables.modules' => 'phpbbmodules',
            'tables.notification_types' => 'phpbbnotification_types',
            'tables.notifications' => 'phpbbnotifications',
            'tables.poll_options' => 'phpbbpoll_options',
            'tables.poll_votes' => 'phpbbpoll_votes',
            'tables.posts' => 'phpbbposts',
            'tables.privmsgs' => 'phpbbprivmsgs',
            'tables.privmsgs_folder' => 'phpbbprivmsgs_folder',
            'tables.privmsgs_rules' => 'phpbbprivmsgs_rules',
            'tables.privmsgs_to' => 'phpbbprivmsgs_to',
            'tables.profile_fields' => 'phpbbprofile_fields',
            'tables.profile_fields_data' => 'phpbbprofile_fields_data',
            'tables.profile_fields_options_language' => 'phpbbprofile_fields_lang',
            'tables.profile_fields_language' => 'phpbbprofile_lang',
            'tables.ranks' => 'phpbbranks',
            'tables.reports' => 'phpbbreports',
            'tables.reports_reasons' => 'phpbbreports_reasons',
            'tables.search_results' => 'phpbbsearch_results',
            'tables.search_wordlist' => 'phpbbsearch_wordlist',
            'tables.search_wordmatch' => 'phpbbsearch_wordmatch',
            'tables.sessions' => 'phpbbsessions',
            'tables.sessions_keys' => 'phpbbsessions_keys',
            'tables.sitelist' => 'phpbbsitelist',
            'tables.smilies' => 'phpbbsmilies',
            'tables.sphinx' => 'phpbbsphinx',
            'tables.styles' => 'phpbbstyles',
            'tables.styles_template' => 'phpbbstyles_template',
            'tables.styles_template_data' => 'phpbbstyles_template_data',
            'tables.styles_theme' => 'phpbbstyles_theme',
            'tables.styles_imageset' => 'phpbbstyles_imageset',
            'tables.styles_imageset_data' => 'phpbbstyles_imageset_data',
            'tables.teampage' => 'phpbbteampage',
            'tables.topics' => 'phpbbtopics',
            'tables.topics_posted' => 'phpbbtopics_posted',
            'tables.topics_track' => 'phpbbtopics_track',
            'tables.topics_watch' => 'phpbbtopics_watch',
            'tables.user_group' => 'phpbbuser_group',
            'tables.user_notifications' => 'phpbbuser_notifications',
            'tables.users' => 'phpbbusers',
            'tables.warnings' => 'phpbbwarnings',
            'tables.words' => 'phpbbwords',
            'tables.zebra' => 'phpbbzebra',
            ...
            'tables' => [
                'acl_groups' => 'phpbbacl_groups',
                'acl_options' => 'phpbbacl_options',
                'acl_roles' => 'phpbbacl_roles',
                'acl_roles_data' => 'phpbbacl_roles_data',
                'acl_users' => 'phpbbacl_users',
                'attachments' => 'phpbbattachments',
                'auth_provider_oauth_token_storage' => 'phpbboauth_tokens',
                'auth_provider_oauth_states' => 'phpbboauth_states',
                'auth_provider_oauth_account_assoc' => 'phpbboauth_accounts',
                'banlist' => 'phpbbbanlist',
                'bbcodes' => 'phpbbbbcodes',
                'bookmarks' => 'phpbbbookmarks',
                'bots' => 'phpbbbots',
                'captcha_qa_questions' => 'phpbbcaptcha_questions',
                'captcha_qa_answers' => 'phpbbcaptcha_answers',
                'captcha_qa_confirm' => 'phpbbqa_confirm',
                'config' => 'phpbbconfig',
                'config_text' => 'phpbbconfig_text',
                'confirm' => 'phpbbconfirm',
                'disallow' => 'phpbbdisallow',
                'drafts' => 'phpbbdrafts',
                'ext' => 'phpbbext',
                'extensions' => 'phpbbextensions',
                'extension_groups' => 'phpbbextension_groups',
                'forums' => 'phpbbforums',
                'forums_access' => 'phpbbforums_access',
                'forums_track' => 'phpbbforums_track',
                'forums_watch' => 'phpbbforums_watch',
                'groups' => 'phpbbgroups',
                'icons' => 'phpbbicons',
                'lang' => 'phpbblang',
                'log' => 'phpbblog',
                'login_attempts' => 'phpbblogin_attempts',
                'migrations' => 'phpbbmigrations',
                'moderator_cache' => 'phpbbmoderator_cache',
                'modules' => 'phpbbmodules',
                'notification_types' => 'phpbbnotification_types',
                'notifications' => 'phpbbnotifications',
                'poll_options' => 'phpbbpoll_options',
                'poll_votes' => 'phpbbpoll_votes',
                'posts' => 'phpbbposts',
                'privmsgs' => 'phpbbprivmsgs',
                'privmsgs_folder' => 'phpbbprivmsgs_folder',
                'privmsgs_rules' => 'phpbbprivmsgs_rules',
                'privmsgs_to' => 'phpbbprivmsgs_to',
                'profile_fields' => 'phpbbprofile_fields',
                'profile_fields_data' => 'phpbbprofile_fields_data',
                'profile_fields_options_language' => 'phpbbprofile_fields_lang',
                'profile_fields_language' => 'phpbbprofile_lang',
                'ranks' => 'phpbbranks',
                'reports' => 'phpbbreports',
                'reports_reasons' => 'phpbbreports_reasons',
                'search_results' => 'phpbbsearch_results',
                'search_wordlist' => 'phpbbsearch_wordlist',
                'search_wordmatch' => 'phpbbsearch_wordmatch',
                'sessions' => 'phpbbsessions',
                'sessions_keys' => 'phpbbsessions_keys',
                'sitelist' => 'phpbbsitelist',
                'smilies' => 'phpbbsmilies',
                'sphinx' => 'phpbbsphinx',
                'styles' => 'phpbbstyles',
                'styles_template' => 'phpbbstyles_template',
                'styles_template_data' => 'phpbbstyles_template_data',
                'styles_theme' => 'phpbbstyles_theme',
                'styles_imageset' => 'phpbbstyles_imageset',
                'styles_imageset_data' => 'phpbbstyles_imageset_data',
                'teampage' => 'phpbbteampage',
                'topics' => 'phpbbtopics',
                'topics_posted' => 'phpbbtopics_posted',
                'topics_track' => 'phpbbtopics_track',
                'topics_watch' => 'phpbbtopics_watch',
                'user_group' => 'phpbbuser_group',
                'user_notifications' => 'phpbbuser_notifications',
                'users' => 'phpbbusers',
                'warnings' => 'phpbbwarnings',
                'words' => 'phpbbwords',
                'zebra' => 'phpbbzebra',
            ],
            'core.adm_relative_path' => 'adm/',
            'core.table_prefix' => 'phpbb',
